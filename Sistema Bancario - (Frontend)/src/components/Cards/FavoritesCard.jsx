...
export const FavoritesCard = ({ id, name, description, amount, onClick }) => {
        ...
        <>
            <div className="card m-3 row g-0 rounded-0" style={{ maxWidth: '18rem', maxHeight: '24rem' }}>
                ...
                <div className="card-body">
                    <p className="mb-1">
                        <strong>Alias</strong> {description}
                    </p>
                    <p className="mb-1">
                        <strong>No. Cuenta</strong> Q{amount}.00
                    </p>
                    <p className="mb-1">
                        <strong>DPI</strong> {description}
                    </p>
                    ...
                    <Link onClick={onClick} className="btn text-light m-2 rounded-0" style={{ backgroundColor: '#F3940C' }}>Transferir</Link>
