        ...
        <>
            <div className='container'>
                ...
                <div className='row g-0 justify-content-center'>
                    {
                        movements.map(({type, userOrigin, userDestination, amount, description, date}, index) =>{
                            const originName = userOrigin ? userOrigin.name : '';
                            const destinationName = userDestination ? userDestination.name : '';
                            return(
