        ...
        <div className="container p-5" style={{ width: '50%', height: '50%', backgroundColor: '#fff' }}>
          ...
          <form>
            <div className="form-group">
              ...
              <input type="text" style={{ borderColor: '#00043a', borderWidth: 4 }} className="border-primary form-control" id="name" placeholder="Nombre Producto" />
            </div>
            <div className="form-group">
              <label htmlFor="inputTelefono">Descripción</label>
              <input type="text" style={{ borderColor: '#00043a', borderWidth: 4 }} className="border-primary form-control" id="description" placeholder="Descripción" />
            </div>
            <div className="form-group">
              <label htmlFor="inputCorreo">Precio</label>
              <input type="number" style={{ borderColor: '#00043a', borderWidth: 4 }} className="border-primary form-control" id="amount" placeholder="Precio" />
            </div>
            <div className="d-flex text-center align-items-center justify-content-center">
              <div className="form-group">
                <Link >
                  <button onClick={(e) => { addProducts(), e.preventDefault() }} className="btn btn-success rounded-0 m-3" type="submit">Agregar Producto</button>
                </Link>
              </div>
              <div className="form-group">
